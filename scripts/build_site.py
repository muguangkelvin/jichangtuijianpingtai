        ...
        for file in files:
            if file.endswith(".md"):
                ...
                if rel_path == "_index.md":
                    ...
                    # Full Homepage HTML
                    hero_html = f'''
                    <div class="hero-box" style="background:#f0f4f8; border-left:5px solid #0056b3; padding:24px; margin:15px 0 25px 0; border-radius:8px; box-shadow:0 1px 4px rgba(0,0,0,0.04);">
                      <h1 style="font-size:1.55rem; color:#1e293b; margin:0 0 14px 0; font-weight:700; line-height:1.4;">2026 稳定高速机场推荐平台：多梯队节点评测与科学选型指南</h1>
                      <div class="hero-keywords-text" style="font-size:0.96rem; color:#334155; line-height:1.75; text-align:justify;">
                        <strong>博客导读：</strong>随着公网 QoS 限速与审查策略的常态化，单纯以“低价、海量流量”为卖点的直连节点已基本难以应对晚高峰。本站基于三网（电信、联通、移动）长期测速样本，深入解析 IPLC/IEPL 物理专线与公网中转的技术差异，全面评测 4K 流媒体秒开率、AI 工具（ChatGPT/Claude）风控稳定性，并提供多梯队的真实推荐与避坑方案。
                      </div>
                      <div style="margin-top:16px; display:flex; gap:12px; flex-wrap:wrap; align-items:center;">
                        <a href="/posts/clash-airport-selection-guide/" class="btn" style="padding:9px 18px; font-weight:600;">阅读 2026 选购指南全文</a>
                        <a href="/service/" class="btn btn-secondary" style="padding:9px 18px; font-weight:600;">体验自营高可用线路</a>
                      </div>
                    </div>
